...
fn plugins(decoded: &toml::Value) {
    ...
    plugin_rs
        .write_all(b"pub(crate) async fn registers(_scx: &ferromq::context::ServerContext, _default_startups: Vec<String>, _disabled_default_startups: Vec<String>) -> ferromq::Result<()>{\n")
        .unwrap();
