...
[![crates.io page](https://img.shields.io/crates/v/ferromq-utils.svg)](https://crates.io/crates/ferromq-utils)
[![docs.rs page](https://docs.rs/ferromq-utils/badge.svg)](https://docs.rs/ferromq-utils/latest/ferromq_utils)

Common utilities for the FerroMQ MQTT broker: byte sizes, durations, timestamps, node addresses, env var expansion, and atomic counters.
