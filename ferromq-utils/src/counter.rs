...
/// ```
/// use ferromq_utils::{Counter, StatsMergeMode};
///
...
impl Counter {
    ...
    /// # Example
    /// ```
    /// let c = ferromq_utils::Counter::new();
    /// ```
    #[inline]
    pub fn new() -> Self {
    ...
    /// # Example
    /// ```
    /// let c = ferromq_utils::Counter::new_with(5, 10, ferromq_utils::StatsMergeMode::Sum);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = ferromq_utils::Counter::new_with(3, 10, ferromq_utils::StatsMergeMode::None);
    /// let b = ferromq_utils::Counter::new_with(2, 5, ferromq_utils::StatsMergeMode::None);
    /// a.add(&b);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = ferromq_utils::Counter::new();
    /// let b = ferromq_utils::Counter::new_with(5, 100, ferromq_utils::StatsMergeMode::None);
    /// a.set(&b);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = ferromq_utils::Counter::new_with(1, 2, ferromq_utils::StatsMergeMode::Sum);
    /// let b = ferromq_utils::Counter::new_with(3, 4, ferromq_utils::StatsMergeMode::Sum);
    /// a.merge(&b);
    /// ```
    #[inline]
