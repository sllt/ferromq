...
/// # Example
/// ```
/// use ferromq::acl::{Rule, Permission, Action, Topic};
/// use ferromq::types::{ConnectInfo, Id, QoS};
/// let rule = Rule {
...
/// # Example
/// ```
/// let perm = ferromq::acl::Permission::try_from("allow").unwrap();
/// ```
...
/// # Example
/// ```
/// let action = ferromq::acl::Action::try_from("publish").unwrap();
/// ```
...
/// # Example
/// ```
/// use ferromq::types::{ConnectInfo, Id};
/// use ferromq::acl::Topic;
