...
//! FerroMQ Broker Core Implementation (v2025.04)
//!
...
//!    - Zero-copy codec implementation from `ferromq_codec`
...
//! use ferromq::net::{Builder, Result};
