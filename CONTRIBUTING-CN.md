...
感谢你考虑为 FerroMQ 贡献代码！本文档概述了开发工作流、代码规范和流程。
...
4. **注明环境信息** — 操作系统、Rust 版本（`rustc --version`）、FerroMQ 版本
...
# 由 ferromq-bin/build.rs 自动完成 — 无需手动操作
```
...
FerroMQ 通过了 [paho.mqtt.testing](https://github.com/eclipse/paho.mqtt.testing) 测试套件：
...
向 FerroMQ 贡献代码即表示你同意你的贡献将按照 [MIT](LICENSE-MIT) 或 [Apache 2.0](LICENSE-APACHE) 许可证（由你选择）进行许可。
