...
*FerroMQ* broker is a fully open source, highly scalable, highly available distributed MQTT messaging broker for IoT, M2M
and mobile applications that can handle millions of concurrent clients on a single service node.

FerroMQ is based on [RMQTT](https://github.com/rmqtt/rmqtt) and continues as an independent project. The original license and author information are retained.
...
The *FerroMQ* broker is cross-platform, which supports Linux, Unix, macOS and Windows. It means *FerroMQ* can be deployed on
...
For more details about using FerroMQ in library mode, please refer to the [FerroMQ Library Documentation](./ferromq/README.md).
...
| [Configuration Guide](./ferromq-conf/README.md) | All configuration options with defaults |
...
| Sub-crate docs | [ferromq](./ferromq/README.md), [ferromq-bin](./ferromq-bin/README.md), [ferromq-codec](./ferromq-codec/README.md), [ferromq-net](./ferromq-net/README.md), [ferromq-conf](./ferromq-conf/README.md), [ferromq-utils](./ferromq-utils/README.md), [ferromq-macros](./ferromq-macros/README.md), [ferromq-storage](./ferromq-storage/README.md), [ferromq-raft](./ferromq-raft/README.md), [ferromq-test](./ferromq-test/README.md) |
...
* client_test.py Test.test_subscribe_failure          [OK]
  * You need to modify the `ferromq-acl.toml` configuration and add the following line at the first line: ["deny", "all", "subscribe", ["test/nosubscribe"]]
...
* client_test5.py Test.test_server_keep_alive           [OK]
  * You need to modify the `ferromq.toml` configuration and change `max_keepalive` to 60.
...
The `ferromq-test` crate provides a custom test harness with functional, stress, and chaos suites beyond paho. See [Test Report](docs/en_US/testing-report.md) for details.
