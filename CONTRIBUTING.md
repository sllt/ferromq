...
# Contributing to FerroMQ

Thank you for considering contributing to FerroMQ! This guide outlines the development workflow, code standards, and processes we follow.
...
4. **Specify your environment** — OS, Rust version (`rustc --version`), FerroMQ version
...
# Done automatically by ferromq-bin/build.rs — no manual step needed
```
...
docs(test): update CLI usage examples for ferromq-test
```
...
2. **Integration tests** — `ferromq-test` harness with five suite types:
...
FerroMQ passes the [paho.mqtt.testing](https://github.com/eclipse/paho.mqtt.testing) test suite:
...
By contributing to FerroMQ, you agree that your contributions will be licensed under the [MIT](LICENSE-MIT) or [Apache 2.0](LICENSE-APACHE) license, at your option.
