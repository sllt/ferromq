...
@REM cargo publish --registry crates-io --all-features --manifest-path ferromq-macros/Cargo.toml
@REM cargo publish --registry crates-io --all-features --manifest-path ferromq-utils/Cargo.toml
@REM cargo publish --registry crates-io --all-features --manifest-path ferromq-codec/Cargo.toml
@REM cargo publish --registry crates-io --all-features --manifest-path ferromq-net/Cargo.toml
@REM cargo publish --registry crates-io --all-features --manifest-path ferromq-conf/Cargo.toml
