...
> **FerroMQ provenance:** imported from [rmqtt-storage](https://github.com/rmqtt/rmqtt-storage) tag `0.11.1` at commit `3f2dc3978d7522d713546510242ff08d7e454b43`; original licenses and author attribution are retained.
...
```toml
[dependencies]
ferromq-storage = { version = "0.11", features = ["sled", "circuit-breaker"] }
```

```rust
use ferromq_storage::circuit_breaker::{CircuitBrokenDB, CircuitBreakerConfig};
use ferromq_storage::init_db;
...
use ferromq_storage::circuit_breaker::CircuitBreakerConfig;
