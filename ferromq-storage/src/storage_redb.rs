...
const MAP_NAME_PREFIX: &[u8] = b"__ferromq_map@";
const LIST_NAME_PREFIX: &[u8] = b"__ferromq_list@";
const KEY_PREFIX: &[u8] = b"__ferromq@";
#[allow(dead_code)]
const KEY_PREFIX_LEN: &[u8] = b"__ferromq_len@";
...
/// Build a map prefix: __ferromq_map@{name}@
#[allow(dead_code)]
...
/// Build a map item prefix: __ferromq_map@{name}@@__item@
...
/// Build a map item key: __ferromq_map@{name}@@__item@{key}
...
/// Build a map count key: __ferromq_map@{name}@@__count@
...
/// Build a list prefix: __ferromq_list@{name}
#[allow(dead_code)]
...
/// Build a list count key: __ferromq_list@{name}@@__count@
...
/// Build a list content key: __ferromq_list@{name}@@__content@{idx_be}
