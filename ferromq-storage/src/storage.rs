...
#[allow(unused)]
pub(crate) const KEY_PREFIX: &[u8] = b"__ferromq@";
#[allow(unused)]
pub(crate) const KEY_PREFIX_LEN: &[u8] = b"__ferromq_len@";
#[allow(unused)]
pub(crate) const MAP_NAME_PREFIX: &[u8] = b"__ferromq_map@";
#[allow(unused)]
pub(crate) const LIST_NAME_PREFIX: &[u8] = b"__ferromq_list@";
