...
[![crates.io page](https://img.shields.io/crates/v/ferromq-codec.svg)](https://crates.io/crates/ferromq-codec)
[![docs.rs page](https://docs.rs/ferromq-codec/badge.svg)](https://docs.rs/ferromq-codec/latest/ferromq_codec)
...
```rust
use bytes::BytesMut;
use ferromq_codec::{MqttCodec, MqttPacket, v3};
...
`tokio-util` (codec)、`bytes`、`bytestring`、`serde`、`thiserror`、`bitflags`、`chrono`、`nonzero_ext`、`ferromq-utils`
