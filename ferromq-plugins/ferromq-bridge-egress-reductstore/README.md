...
[![crates.io](https://img.shields.io/crates/v/ferromq-bridge-egress-reductstore.svg)](https://crates.io/crates/ferromq-bridge-egress-reductstore)
...
```toml
ferromq-bridge-egress-reductstore = "0.21"
```
...
File: `ferromq-bridge-egress-reductstore.toml`
...
`ferromq` (feature `plugin`), `reduct-rs`, `tokio`
