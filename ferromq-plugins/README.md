...
[![crates.io page](https://img.shields.io/crates/v/ferromq-plugins.svg)](https://crates.io/crates/ferromq-plugins)
[![docs.rs page](https://docs.rs/ferromq-plugins/badge.svg)](https://docs.rs/ferromq-plugins/latest/ferromq_plugins)

Plugin collection meta-crate for the [FerroMQ](https://github.com/rmqtt/rmqtt) MQTT broker. Each plugin is conditionally re-exported via feature flags (`#![deny(missing_docs)]`).
...
ferromq_plugins::acl::register_named(&scx, "ferromq-acl", true, false).await?;
ferromq_plugins::http_api::register_named(&scx, "ferromq-http-api", true, false).await?;
```
