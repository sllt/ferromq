...
//! for storing messages via the `ferromq_storage` backend (Sled/Redis),
...
use ferromq::topic::Level;
#[cfg(feature = "circuit-breaker")]
pub(crate) use ferromq_storage::{CircuitBrokenDB as StorageDb, CircuitBrokenMap as StorageMap};
#[cfg(not(feature = "circuit-breaker"))]
pub(crate) use ferromq_storage::{DefaultStorageDB as StorageDb, StorageMap};

use ferromq_storage::{Map, StorageDB as _};
...
/// A persistent message manager backed by `ferromq_storage`.
///
        ...
        for i in 0..WORKER_COUNT {
            ...
            tokio::spawn(async move {
                ...
                while let Some(msg) = rx.next().await {
                    ...
                    // will fast-fail through the ferromq-storage circuit breaker.
