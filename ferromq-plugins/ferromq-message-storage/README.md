...
[![crates.io](https://img.shields.io/crates/v/ferromq-message-storage.svg)](https://crates.io/crates/ferromq-message-storage)
...
```toml
[dependencies]
ferromq-message-storage = { version = "0.21", features = ["ram"] }
...
File: `ferromq-message-storage.toml`
...
inherited from the global `[circuit_breaker]` section in `ferromq.toml`.
...
`ferromq` (features: `plugin`, `msgstore`), redis (optional)
