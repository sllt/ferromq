...
[![crates.io](https://img.shields.io/crates/v/ferromq-bridge-origin.svg)](https://crates.io/crates/ferromq-bridge-origin)
...
```toml
ferromq-bridge-origin = "0.21"
```

```rust
ferromq_bridge_origin::register(&scx, true, false).await?;
```

## Configuration

File: `ferromq-bridge-origin.toml`
...
Loaded via `scx.plugins.load_config_default::<PluginConfig>("ferromq-bridge-origin")`.

```toml
# ferromq-bridge-origin.toml
