...
[![crates.io](https://img.shields.io/crates/v/ferromq-auth-jwt.svg)](https://crates.io/crates/ferromq-auth-jwt)

JWT authentication plugin for FerroMQ. Validates JSON Web Tokens for client authentication.
...
| `hmac_secret` | String | `"ferromqsecret"` | HMAC hash secret |
...
validate_claims.iss = ["https://ferromq.local"]
