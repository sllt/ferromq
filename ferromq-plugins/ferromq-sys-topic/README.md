...
[![crates.io](https://img.shields.io/crates/v/ferromq-sys-topic.svg)](https://crates.io/crates/ferromq-sys-topic)

System topics plugin for FerroMQ. Publishes broker metrics as `$SYS/` MQTT topics for monitoring.
...
- **Version information**: FerroMQ version and build info
