...
[![crates.io](https://img.shields.io/crates/v/ferromq-topic-rewrite.svg)](https://crates.io/crates/ferromq-topic-rewrite)

Topic rewrite plugin for FerroMQ. Rewrites/remaps MQTT topic filters and topic names using configurable rules.
...
File: `ferromq-topic-rewrite.toml`
