//! Raft-based cluster plugin for FerroMQ.
//!
...
//! - Leader election and log replication are handled by `ferromq-raft`.
...
/// replication across FerroMQ broker nodes.
#[derive(Plugin)]
