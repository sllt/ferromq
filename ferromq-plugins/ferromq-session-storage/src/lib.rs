//! Session storage plugin for FerroMQ.
//!
...
use ferromq::inflight::OutInflightMessage;
use ferromq::macros::Plugin;
use ferromq::session::SessionState;
