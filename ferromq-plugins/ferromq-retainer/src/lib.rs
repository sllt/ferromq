//! Retained message storage plugin for FerroMQ.
//!
...
use ferromq::{context::ServerContext, hook::Register, macros::Plugin, plugin::Plugin, register, Result};

#[cfg(any(feature = "sled", feature = "redis"))]
use ferromq_storage::{init_db, StorageType};
#[cfg(feature = "ram")]
use ram::RamRetainer;

use config::{Config, PluginConfig};
use ferromq::plugin::PackageInfo;
use ferromq::retain::RetainStorage;
