...
use ferromq::utils::{deserialize_duration, deserialize_duration_option, Bytesize};
use ferromq::Result;

#[cfg(feature = "circuit-breaker")]
use ferromq::context::CircuitBreakerConfig as GlobalCBConfig;
#[cfg(feature = "circuit-breaker")]
use ferromq_storage::{
...
impl PluginConfig {
        ...
        D: Deserializer<'de>,
    {
        ...
        match typ {
            ...
            Some("sled") | Some("redis") => {
                match serde_json::from_value::<ferromq_storage::Config>(storage) {
                    Err(e) => Err(de::Error::custom(e.to_string())),
...
pub enum Config {
    ...
    Ram,
    #[cfg(any(feature = "sled", feature = "redis"))]
    Storage(ferromq_storage::Config),
}
