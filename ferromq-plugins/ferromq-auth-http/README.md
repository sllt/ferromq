...
[![crates.io](https://img.shields.io/crates/v/ferromq-auth-http.svg)](https://crates.io/crates/ferromq-auth-http)

HTTP authentication plugin for FerroMQ. Delegates client authentication and ACL checks to an external HTTP API.
...
| `http_headers.User-Agent` | String | `"FerroMQ/0.15.0"` | User agent header |
