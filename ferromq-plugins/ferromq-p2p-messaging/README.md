...
[![crates.io](https://img.shields.io/crates/v/ferromq-p2p-messaging.svg)](https://crates.io/crates/ferromq-p2p-messaging)

Peer-to-peer messaging plugin for FerroMQ. Enables direct client-to-client message delivery over MQTT topics.
...
```toml
ferromq-p2p-messaging = "0.21"
```

Register the plugin in your broker startup code:

```rust
ferromq_p2p_messaging::register(&scx, true, false).await?;
```

## Configuration

File: `ferromq-p2p-messaging.toml`
