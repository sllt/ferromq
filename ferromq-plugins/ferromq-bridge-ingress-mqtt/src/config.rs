...
use ferromq::codec::types::{Protocol, MQTT_LEVEL_31, MQTT_LEVEL_311, MQTT_LEVEL_5};
...
impl Local {
    ...
    #[inline]
    pub fn make_qos(&self, remote_qos: QoS) -> ferromq::types::QoS {
        let qos = self.qos.unwrap_or(remote_qos);
        match qos {
            QoS::AtMostOnce => ferromq::types::QoS::AtMostOnce,
            QoS::AtLeastOnce => ferromq::types::QoS::AtLeastOnce,
            QoS::ExactlyOnce => ferromq::types::QoS::ExactlyOnce,
        }
    }
