...
use ferromq::net::MqttError;
use ferromq::retain::RetainSyncMode;
use ferromq::shared::{DefaultShared, Entry, MessageLoadCallback, Shared};
use ferromq::types::{HealthInfo, MsgID, NodeHealthStatus, Retain, TopicName};
...
impl Shared for ClusterShared {
    ...
    async fn retain_load_with(
        ...
        cb: Arc<dyn ferromq::shared::RetainLoadCallback>,
        ...
        if retain_mgr.merge_on_read() {
            ...
            let deduped = ferromq::shared::dedup_retains_by_topic(all_retains);
