...
[![crates.io](https://img.shields.io/crates/v/ferromq-cluster-broadcast.svg)](https://crates.io/crates/ferromq-cluster-broadcast)
...
```toml
[dependencies]
ferromq-cluster-broadcast = "0.21"
```

```rust
ferromq_cluster_broadcast::register(&scx, true, false).await?;
```

## Configuration

File: `ferromq-cluster-broadcast.toml`
