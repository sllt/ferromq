...
[![crates.io](https://img.shields.io/crates/v/ferromq-web-hook.svg)](https://crates.io/crates/ferromq-web-hook)
...
| `urls` | array of string | `["file:///var/log/ferromq/hook.log"]` | HTTP POST or file output URLs |
...
`ferromq` (feature `plugin`), `reqwest` (rustls-tls, json)
