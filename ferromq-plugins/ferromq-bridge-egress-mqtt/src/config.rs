...
impl Remote {
    ...
    #[inline]
    pub fn make_qos(&self, remote_qos: ferromq::types::QoS) -> QoS {
        self.qos.unwrap_or(match remote_qos {
            ferromq::types::QoS::AtMostOnce => QoS::AtMostOnce,
            ferromq::types::QoS::AtLeastOnce => QoS::AtLeastOnce,
            ferromq::types::QoS::ExactlyOnce => QoS::ExactlyOnce,
        })
    }
