...
[![crates.io](https://img.shields.io/crates/v/ferromq-auto-subscription.svg)](https://crates.io/crates/ferromq-auto-subscription)

Auto-subscription plugin for FerroMQ. Automatically subscribes clients to predefined topic filters when they connect.
...
```toml
ferromq-auto-subscription = "0.21"
```
...
File: `ferromq-auto-subscription.toml`
