...
The *ferromq-p2p-messaging* plugin provides point-to-point (P2P) messaging support.
...
To enable it, you must add `ferromq-p2p-messaging` to the `plugins.default_startups` section in the main configuration file `ferromq.toml`, for example:
